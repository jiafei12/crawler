...
import com.example.crawler.pojo.HttpClientResult;
...
public class HttpUtils {
     ...
     * @param params 请求参数集合
     */
    private static HttpClientResult doPost(String url, Map<String, String> headers, Map<String, String> params) throws Exception {
        // 创建httpClient对象
        CloseableHttpClient httpClient = HttpClients.createDefault();
